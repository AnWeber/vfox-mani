...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/anweber/vfox-mani"
--- Plugin license, please choose a correct license according to your needs.
PLUGIN.license = "MIT"
--- Plugin description
PLUGIN.description = "mani - CLI tool to help you manage repositories"
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/anweber/vfox-mani/releases/download/manifest/manifest.json"
